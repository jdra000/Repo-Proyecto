...
def functionality(starting_node, ending_node):
...
if __name__ == '__main__':
    starting_node = input("Ingrese nodo de entrada: ")
    ending_node = input("Ingrese nodo de salida: ")
    functionality(starting_node, ending_node)
